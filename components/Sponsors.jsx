  ...
  return (
    ...
    >
      ...
      <section className='space-y-6'>
        ...
        <p>
          ServerlessDays is a community-focused, single-track, one-day event
          that moves away from the hype and focuses on the reality
          serverless-based solutions. It&apos;s about fostering a community
          locally and helping all of us learn from each other as we embrace a
