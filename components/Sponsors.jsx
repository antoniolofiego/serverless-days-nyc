...
export const Sponsors = () => {
  ...
  return (
    ...
    >
      ...
      {/* Headline/Location */}
      <div className='grid grid-cols-1 gap-x-32 md:grid-cols-2 gap-y-8'>
      ...
      <div className='space-y-8'>
        ...
        <div className='grid grid-cols-1 gap-x-32 md:grid-cols-3 gap-y-8'>
          <a
          ...
          >
            <div className='flex items-center h-32 md:h-56'>
              <div className='relative w-full h-24'>
                <Image
                  className='h-24 fill-gray-900 dark:fill-gray-50'
