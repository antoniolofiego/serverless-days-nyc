  ...
  return (
    <>
      <motion.button
        ...
        onClick={() => open()}
        className='flex items-center max-w-full py-4 transition-all border border-gray-900 divide-x-2 rounded-lg lg:max-w-md grow lg:grow-0 bg-gradient-to-tl from-gray-200 to-blue-50 dark:bg-gradient-to-tl dark:from-gray-900 dark:to-blue-900 dark:active:bg-gradient-to-tl dark:active:from-gray-900 dark:active:to-blue-800 min-h-[10rem] dark:border-gray-50 w-full'
      >
