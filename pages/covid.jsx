...
const CovidPolicy = () => {
  return (
    <>
      <Head>
        <title>COVID 19 Policy - ServerlessDays NYC</title>
        <description>
      ...
      <div className='max-w-md pb-16 mx-auto space-y-8 lg:max-w-5xl md:max-w-2xl sm:max-w-xl'>
        ...
        <ul>
          <li>
            Proof of vaccination or negative COVID test within the last seven
            days is <strong>mandatory</strong>.
          </li>
          <li>
          ...
          <li>
            ServerlessDays NYC 2022 organizers will lead by example and mask at
            all times to create an environment where all attendees feel
        ...
        <p>
          Guests and customers will be able to provide proof of vaccination via
          the{' '}
          <a
            href='https://msrtw.powerappsportals.com/en-US/'
            target='_blank'
            rel='noreferrer'
          >
            HealthCheck portal
          </a>{' '}
          or self-attest to having received a negative COVID-19 test within the
          last 7 days.
        </p>
        ...
        <p>
          Microsoft&apos;s vaccination policy will be enforced for all
          employees, visitors, external staff, guests, and customers.
        </p>
        ...
        <p>
          ...
          recommends{' '}
          <a
            href='https://health.ny.gov/press/releases/2022/2022-05-13_covid_mask_recommendation.htm'
            target='_blank'
            rel='noreferrer'
          >
            &quot;all New Yorkers in high-risk counties ... wear masks in indoor
            public spaces, regardless of vaccination status.&quot;
          </a>
        </p>
